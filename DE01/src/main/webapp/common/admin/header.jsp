<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <div class="container">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/home">Trang chủ admin</a>
            <div class="navbar-nav ms-auto">
                <span class="navbar-text me-3">Hi, ${sessionScope.account.fullname} (Admin)</span>
