	...
	<div class="container py-5">
		<div class="card p-4">
			<div class="d-flex justify-content-between align-items-center mb-4">
				...
				<div>
					<a href="${pageContext.request.contextPath}/admin/category/search"
						...
						<c:forEach items="${categories}" var="category">
							<tr>
								...
								<td class="align-middle"><c:if
										test="${not empty category.images}">
										<img
											src="${pageContext.request.contextPath}/image?fname=${category.images}"
											alt="Category image" class="category-image">
									</c:if> <c:if test="${empty category.images}">
										<div
											class="category-image d-flex align-items-center justify-content-center bg-light text-muted">
						...
						<c:if test="${empty categories}">
							<tr>
								<td colspan="4" class="text-center text-muted py-4"><i
									class="fa fa-inbox fa-3x mb-3 d-block"></i> Chưa có danh mục
									nào</td>
							</tr>
						</c:if>
					</tbody>
